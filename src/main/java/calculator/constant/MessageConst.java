...
public class MessageConst {
    public static final String START_MSG = "덧셈할 문자열을 입력해 주세요.";
    public static final String OUTPUT_MSG = "결과 : ";
    ...
    public static final String INPUT_CUSTOM_LENGTH_EXCEPTION_MSG = "구분자는 문자 하나여야 합니다.";
